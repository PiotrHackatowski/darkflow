class argHandler(dict):
    ...
    def setDefaults(self):
        ...
        self.define('xml', False, 'Outputs bounding box information in xml format.')
        self.define('labelToChange', '', 'If label found then change it to newLabel')
        self.define('newLabel', '', 'New Label of labelToChange object')
